...
//         if (SoLuong > 5)
//         {
//             return TinhGiaTriKho()*0.9;
//         }
//         return TinhGiaTriKho();
//     }
//     public void Xuat()
//     {
//         Console.WriteLine("MaDT: {0} | TenDT: {1} | Don Gia: {2} | So Luong: {3} | Gia tri: {4} | Hang san xuat: {5} ",MaDT,TenDT,DonGia,SoLuong,TinhGiaTriKho(), HangSX);
//     }
// }
// class Program
// {
